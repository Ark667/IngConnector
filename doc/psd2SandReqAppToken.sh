...
reqDate="Fri, 04 Mar 2022 21:45:52 GMT"
...
# echo `printf %s "$signingString"`
# echo $signingString
# echo `printf %s "$signingString" | openssl dgst -sha256 -sign "${certPath}example_client_signing.key" -passin "pass:changeit"`
echo $signature
